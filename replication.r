...
# reported AUC values. This has now been corrected so that the revised figures will have the
...
# "Population (logged)", "Linguistic Heterogeneity", "Anocracy", "Median Regional Polity Score",
